...
void
status (const __FlashStringHelper *msg)
{
  tft.fillRect (0, 0, 240, 8, BLACK);
  tft.setCursor (0, 0);
...
setup (void)
{
  ...
  if (identifier == 0x9325)
  ...
  else
    {
      ...
      Serial.println (
	  F("If using the Elegoo 2.8\" TFT Arduino shield, the line:"));
...
loop (void)
{
  ...
  tft.fillRect (0, lineNumber, 240, 14, BLACK);
  tft.print (i);
  tft.print ("\n");
  i++;
